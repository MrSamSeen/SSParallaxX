...
app.registerExtension({
  ...
  async beforeRegisterNodeDef(nodeType, nodeData) {
    ...
    if (
      nodeData.name === "SS_Image_Uploader" ||
      nodeData.name === "SS_Images_to_Video_Combiner"
    ) {
      ...
      nodeType.prototype.onNodeCreated = function () {
        ...
        const widgetName =
          nodeData.name === "SS_Images_to_Video_Combiner" ? "images" : "image";
        ...
        this.addWidget("button", "Upload " + widgetName, "upload", () => {
          ...
          if (nodeData.name === "SS_Images_to_Video_Combiner") {
